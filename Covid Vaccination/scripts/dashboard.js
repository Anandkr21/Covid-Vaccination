let dashboard = JSON.parse(localStorage.getItem('detail')) || []
display(dashboard)
...
function display(dashboard){
    ...
    dashboard.forEach((el,ind)=> {
        ...
        v.addEventListener('click', () =>{
            ...
            if(confirmOtp==el.otp){
                ...
                setTimeout(() => {
                    ...
                    localStorage.setItem('detail', JSON.stringify(dashboard))
        ...
        row.append(name,uniqe,age,d,priority, select,o,v,dlt)
